      ...
      <div className="flex flex-wrap border rounded-lg overflow-hidden gap-x-4 sm:gap-y-4 lg:gap-6">
        ...
        <div className="flex flex-col justify-between flex-1 py-4">
          <div>
            ...
            <span className="block text-gray-500">Charge: {charge}</span>
          </div>
          ...
          <div>
            ...
            <span className="flex items-center text-gray-500 text-sm gap-1">
              {available ? (
                ...
                <span>Not Available for rent</span>
              )}
            </span>
            <button className="mt-3 text-indigo-500 hover:text-indigo-600 active:text-indigo-700 text-sm font-semibold select-none transition duration-100" onClick={(e, id) => formDeleteHandler(e, id)}>
              Delete bike
            </button>
          </div>
        </div>
